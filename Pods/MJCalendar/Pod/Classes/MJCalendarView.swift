...
public class MJCalendarView: UIView, UIScrollViewDelegate, MJComponentDelegate {
    ...
    func eventsForDay(omponentView: MJComponentView, date: NSDate) -> [NSDictionary]? {
        return self.calendarDelegate?.calendar(self, eventsForDate: date)
    }
    ...
    public func firstDate() -> NSDate {
        
        let retVal = currentPeriod().startingDate()
    ...
    public func lastDate() -> NSDate {
        
        let retVal = currentPeriod().endingDate()
